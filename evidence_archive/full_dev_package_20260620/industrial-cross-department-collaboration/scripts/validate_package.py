...
REQUIRED_FILES = [
    ...
    "tests/gui_retest_run_record.csv",
    "tests/evidence/README.md",
    "tests/run_outputs/README.md",
    "tests/gui_retest_outputs/README.md",
    ...
    "tests/astronclaw_gui_retest_prompt_pack.md",
    ...
    "tests/sku_quality_coordination_analysis.md",
    "tests/sku_department_timeline_analysis.md",
